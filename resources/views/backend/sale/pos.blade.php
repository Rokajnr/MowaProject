                    ...
                    <div class="bill-item">
                        <div class="row">
                            ...
                            <div class="col-9">
                                ...
                                <a href="{{url('sales/'.$draft->id.'/create') }}" class="" title="Edit Bill">
                                ...
                                <div class="delete-bill">
                                    ...
                                    <a type="submit" class="btn btn-sm" onclick="return confirmDelete()" title="Delete"><i class="fa-light fa-trash"></i></a>
                                    {{ Form::close() }}
                                    @endif
                                    
                                </div>
                                <div class="bill-date"><h5><i class="fa-light fa-calendar-check" style="padding-right: 4px;color: #03a9f4;font-size: 16px;"></i> {{date('d-m-Y', strtotime($draft->created_at))}}</h5></div>
                        ...
                        <table id="product-table" class="table no-shadow product-list">
                            ...
                            <tbody>
                                @for ($i=0; $i < ceil($product_number/5); $i++) <tr>
                                    <td class="product-img sound-btn" title="{{$lims_product_list[0+$i*5]->name}}" data-product="{{$lims_product_list[0+$i*5]->code . ' (' . $lims_product_list[0+$i*5]->name . ')'}}"><button type="button" class="btn btn-default plus"  style="    border: 1px solid #ccc;
                                        padding: 4px 8px;
                                        float: right;
                                        background: transparent;"><i class="dripicons-plus"></i></button></span><img src="{{url('public/images/product',$lims_product_list[0+$i*5]->base_image)}}" width="100%" />
                                        <p>{{$lims_product_list[0+$i*5]->name}}</p>
                                    </td>
                                    @if(!empty($lims_product_list[1+$i*5]))
                                    <td class="product-img sound-btn" title="{{$lims_product_list[1+$i*5]->name}}" data-product="{{$lims_product_list[1+$i*5]->code . ' (' . $lims_product_list[1+$i*5]->name . ')'}}"><button type="button" class="btn btn-default plus"  style="    border: 1px solid #ccc;
                                        padding: 4px 8px;
                                        float: right;
                                        background: transparent;"><i class="dripicons-plus"></i></button><img src="{{url('public/images/product',$lims_product_list[1+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[2+$i*5]->name}}" data-product="{{$lims_product_list[2+$i*5]->code . ' (' . $lims_product_list[2+$i*5]->name . ')'}}"><button type="button" class="btn btn-default plus"  style="    border: 1px solid #ccc;
                                        padding: 4px 8px;
                                        float: right;
                                        background: transparent;"><i class="dripicons-plus"></i></button><img src="{{url('public/images/product',$lims_product_list[2+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[3+$i*5]->name}}" data-product="{{$lims_product_list[3+$i*5]->code . ' (' . $lims_product_list[3+$i*5]->name . ')'}}"><button type="button" class="btn btn-default plus"  style="    border: 1px solid #ccc;
                                        padding: 4px 8px;
                                        float: right;
                                        background: transparent;"><i class="dripicons-plus"></i></button><img src="{{url('public/images/product',$lims_product_list[3+$i*5]->base_image)}}" width="100%" />
                                    ...
                                    <td class="product-img sound-btn" title="{{$lims_product_list[4+$i*5]->name}}" data-product="{{$lims_product_list[4+$i*5]->code . ' (' . $lims_product_list[4+$i*5]->name . ')'}}"><button type="button" class="btn btn-default plus"  style="    border: 1px solid #ccc;
                                        padding: 4px 8px;
                                        float: right;
                                        background: transparent;"><i class="dripicons-plus"></i></button><img src="{{url('public/images/product',$lims_product_list[4+$i*5]->base_image)}}" width="100%" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row select-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="text" id="reference-no" name="reference_no" class="form-control" placeholder="Reference number" onkeyup='saveValue(this);' />
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group pos customer-options">
                                                ...
                                                <button type="button" class="add-customer-btn btn dropdown-toggle btn-link" data-toggle="dropdown" role="button" data-id="customer_id"><i class="fa-light fa-list"></i></button>
                                                <button type="button" class="add-customer-btn btn btn-default btn-sm" data-toggle="modal" data-target="#addCustomer"><i class="fa-light fa-user-plus"></i></button>
                                                @else
                                                <?php
                                                $deposit = [];
                                                $points = [];
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        <div class="col-6 discount-btn">
                                            <span class="totals-title"><a type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount-modal"><i class="dripicons-document-edit"></i>{{trans('file.Discount')}} </a></span><span id="discount">0.00</span>
                                        </div>
                                        <div class="col-6 tax-btn">
                                            <span class="totals-title"><a type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i> {{trans('file.Tax')}}  </a></span><span id="tax">0.00</span>
                                        </div>
                                            ...
                                            <div class="col-9">
                                                <div class="totals-title" style="font-weight: 800">{{trans('file.Total')}}</div>
                                            </div>
                                            <div class="col-3">
