                ...
                <ul class="navbar-nav mb-lg-7">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#productCollapse" aria-expanded="false" data-bs-toggle="collapse">
                            ...
                            <span>{{ __('file.product') }}</span><span></a>                        <div class="collapse" id="productCollapse">
                        ...
                        <li class="nav-item dropdown">
                            <li class="nav-item dropdown"><a class="nav-link" href="#purchaseCollapse" aria-expanded="false" data-bs-toggle="collapse" role="button" aria-controls="purchaseCollapse">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="18" width="18" class="nav-link-icon"><defs><style>.a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}</style></defs><title>credit-card-1</title><rect class="a" x="0.75" y="3.75" width="22.5" height="16.5" rx="1.5" ry="1.5"></rect><line class="a" x1="0.75" y1="8.25" x2="23.25" y2="8.25"></line><line class="a" x1="5.25" y1="12.75" x2="13.5" y2="12.75"></line><line class="a" x1="5.25" y1="15.75" x2="10.5" y2="15.75"></line></svg>
                                    <span>{{ trans('file.Purchase') }}</span></a>                            <div class="collapse" id="purchaseCollapse">
                                <ul class="nav flex-column">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#saleCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="saleCollapse">
                            ...
                            <span>{{ trans('file.Sale') }}</span></a>                        <div class="collapse" id="saleCollapse">
                            <ul class="nav flex-column">
                                @if ($index_permission_active)
                    ...
                    @if ($index_permission_active)
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#quotationCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="quotationCollapse">
                    ...
                    @if ($index_permission_active)
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#transferCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="transferCollapse">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#returnCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="returnCollapse">
                            ...
                            <span>{{ trans('file.return') }}</span></a>                        <div class="collapse" id="returnCollapse">
                            <ul class="nav flex-column">
                                <?php
                                $index_permission = DB::table('permissions')
                    ...
                    @if ($index_permission_active || $balance_sheet_permission_active || $account_statement_permission_active)
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#accountCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="accountCollapse">
                                ...
                                <span>{{ trans('file.Accounting') }}</span></a>                            <div class="collapse" id="accountCollapse">
                                <ul class="nav flex-column">
                                    @if ($index_permission_active)
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#hrmCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="hrmCollapse">
                            ...
                            <span>HRM</span></a>                        <div class="collapse" id="hrmCollapse">
                            <ul class="nav flex-column">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#peopleCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="peopleCollapse">
                            ...
                            <span>{{ trans('file.People') }}</span></a>                        <div class="collapse" id="peopleCollapse">
                            <ul class="nav flex-column">
