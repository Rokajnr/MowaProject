                                ...
                                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                    ...
                                    @if(($alert_product + count(\Auth::user()->unreadNotifications)) > 0)
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" title="{{__('Notifications')}}"
                                               id="notification-icon" title="{{__('Notifications')}}" role="button"
                                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="dripicons-bell"></i><span
                                                    class="badge badge-danger notification-number">{{$alert_product + count(\Auth::user()->unreadNotifications)}}</span>
                                            </a>
                                            <div class="dropdown-menu notif-icon" aria-labelledby="notification-icon">
                                                <a href="{{route('report.qtyAlert')}}" class="dropdown-item"><span
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                                ...
                                                @endif
                                                <a class="dropdown-item" href="{{route('sales.printLastReciept')}}"
                                                   data-toggle="tooltip" title="{{trans('file.Print Last Reciept')}}"><i
                                                        class="dripicons-print"></i> Print Last Receipt</a>
                                                <a class="dropdown-item" href="" id="register-details-btn"
                                                   data-toggle="tooltip"
                                                ...
                                                @if($today_sale_permission_active)
                                                    <a class="dropdown-item" href="" id="today-sale-btn"
                                                       data-toggle="tooltip" title="{{trans('file.Today Sale')}}"><i
                                                            class="dripicons-shopping-bag"></i> Today's Sales</a>
                                                @endif
                                                @if($today_profit_permission_active)
                                                    <a class="dropdown-item" href="" id="today-profit-btn"
                                                       data-toggle="tooltip" title="{{trans('file.Today Profit')}}"><i
                                                            class="dripicons-graph-line"></i> Today's Profit</a>
                                                @endif
                                            </div>
                                        </li>
                                    @endif
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="adminDropDownMenu">
                                            ...
                                            @if($general_setting_permission_active)
                                                <a class="dropdown-item" href="{{route('setting.general')}}"><i
